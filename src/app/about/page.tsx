  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white p-8 rounded-2xl border-2 border-[#0A192F] hover:bg-[#0A192F] hover:border-transparent transition-all duration-500 group"
            >
              <h2 className="text-3xl font-bold text-[#0A192F] group-hover:text-white transition-colors duration-500 mb-6">Our Mission</h2>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500"
            >
              <Image
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#0A192F] mb-12 text-center">Our History</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white p-8 rounded-2xl border-2 border-[#0A192F] hover:bg-[#0A192F] hover:border-transparent transition-all duration-500 group hover:shadow-2xl"
            >
              <h3 className="text-2xl font-bold text-[#0A192F] group-hover:text-white transition-colors duration-500 mb-4">Founded in 1995</h3>
              <p className="text-gray-700 group-hover:text-white/90 transition-colors duration-500">
            ...
            <motion.div
              ...
              className="bg-white p-8 rounded-2xl border-2 border-[#0A192F] hover:bg-[#0A192F] hover:border-transparent transition-all duration-500 group hover:shadow-2xl"
            >
              <h3 className="text-2xl font-bold text-[#0A192F] group-hover:text-white transition-colors duration-500 mb-4">Growing Years</h3>
              <p className="text-gray-700 group-hover:text-white/90 transition-colors duration-500">
            ...
            <motion.div
              ...
              className="bg-white p-8 rounded-2xl border-2 border-[#0A192F] hover:bg-[#0A192F] hover:border-transparent transition-all duration-500 group hover:shadow-2xl"
            >
              <h3 className="text-2xl font-bold text-[#0A192F] group-hover:text-white transition-colors duration-500 mb-4">Today</h3>
              <p className="text-gray-700 group-hover:text-white/90 transition-colors duration-500">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#0A192F] mb-12 text-center">Our Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value) => (
              <Card
                key={value.title}
                title={value.title}
                className="text-center group/card hover:shadow-2xl transition-all duration-500 bg-white hover:bg-[#0A192F] border-2 border-[#0A192F] hover:border-transparent"
              >
                <h3 className="text-xl font-bold text-[#0A192F] group-hover/card:text-white transition-colors duration-500 mb-3">
                  {value.title}
                </h3>
                <p className="text-gray-700 group-hover/card:text-white/90 transition-colors duration-500">
                  {value.description}
                </p>
              </Card>
            ))}
